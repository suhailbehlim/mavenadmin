      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{ route('admin.update-programme', $testoInfo->id) }}" enctype="multipart/form-data">
                @csrf
        ...
        <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea  name="list"  id="list" class="ckeditor form-control @error('list') is-invalid @enderror" autocomplete="list"  autofocus >{{$testoInfo->list}}</textarea>
              ...
              <div class="form-group">
                ...
                <textarea  name="description"  id="description" class="ckeditor form-control @error('description') is-invalid @enderror" placeholder="Enter description"  autocomplete="description"  autofocus >{{$testoInfo->description}}</textarea>
