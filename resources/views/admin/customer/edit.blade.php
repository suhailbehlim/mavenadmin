        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
            	...
            	<form method="post" action="{{ route('admin.updateCustomer', $customerInfo['id']) }}" enctype="multipart/form-data">
            		@csrf
              ...
              <div class="form-group">
                ...
                <input type="text" name="age" id="age" value="{{$customerInfo['age']}}" class="form-control @error('age') is-invalid @enderror" placeholder="Enter Age." required autocomplete="age" autofocus>
