        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('admin.categoryList') }}">Category List</a></li>
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
            	...
            	<form method="post" action="{{ route('admin.updateCategory', $categoryId) }}" enctype="multipart/form-data">
            		@csrf
