      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
                ...
                <a href="{{route('admin.addFaq')}}" class="btn btn-info btn-sm float-sm-left ml-1"><i class="fa fa-plus" aria-hidden="true"></i> Add New question</a>
